...
def upscale_png_files(source_folder):
    print("PNG dosyaları upscale ediliyor...")
    ...
    for png_file in png_files:
        ...
        try:
            with Image.open(input_path) as img:
                # Transparanlık varsa RGBA, yoksa RGB
                ...
                print(f"Upscaled: {png_file}")
        except Exception as e:
            print(f"Error upscaling {png_file}: {e}")
...
if png_files:
    ...
    print("Lets Get Boho Art PNG dosya transferi işlemi tamamlandı.") 