...
def resize_and_crop_image(image, resize_size=(3000, 2400), crop_size=(2300, 2300)):
    ...
    if 0.95 <= aspect_ratio <= 1.05:
        ...
        # Kare olmayan görseller için mevcut mantığı uygula
...
print(f"{HEADER}=== NeSvg İşlemi Başlatılıyor ==={ENDC}")
...
if eps_files:
    ...
    print(f"{GREEN}NeSvg dosya transferi işlemi tamamlandı!{ENDC}")
