// Fish Habitat Types - Balık Yaşam Alanları (Web ile Senkronize)
...
export const habitatTypeMap: Record<string, HabitatType> = {
  ...
  'marine': {
    ...
    tr: 'Deniz',
    en: 'Marine',
    description_tr: 'Deniz ve okyanus ortamlarında yaşar',
    description_en: 'Lives in oceans and seas',
    source: 'FishBase'
  },
  'reef': {
    color: 'bg-orange-100 text-orange-800',
    tr: 'Resif',
    en: 'Reef',
    description_tr: 'Mercan resifi ortamlarında yaşar',
    description_en: 'Lives in coral reef environments',
    source: 'FishBase'
  },
  'pelagic': {
    color: 'bg-blue-100 text-blue-800',
    tr: 'Pelajik',
    en: 'Pelagic',
    description_tr: 'Açık okyanus sularında yaşar',
    description_en: 'Lives in open ocean waters',
    source: 'FishBase'
  },
  'benthic': {
    color: 'bg-purple-100 text-purple-800',
    tr: 'Bentik',
    en: 'Benthic',
    description_tr: 'Deniz tabanında veya yakınında yaşar',
    description_en: 'Lives on or near the ocean floor',
    source: 'FishBase'
  },
};
