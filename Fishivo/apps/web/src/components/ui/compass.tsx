  ...
  return (
    <>
      <div className="relative -mt-5 flex h-[10rem] w-[10rem] items-center justify-center md:-mt-5 md:h-[9rem] md:w-[9rem]">
        <TypographySmall className="absolute font-semibold">
        ...
        >
          <g fill="none" fillRule="evenodd" opacity=".401">
            ...
            <g
              ...
              fontWeight="bold"
            >
              <text fill="#DC2626" transform="translate(60 60)">
                <tspan x="92.501" y={33}>
                  N
                </tspan>
              </text>
              <text fill="#F97316" transform="translate(60 60)">
                <tspan x="178.494" y={118}>
                  E
                </tspan>
              </text>
              <text fill="#10B981" transform="translate(60 60)">
                <tspan x="93.494" y={203}>
                  S
                </tspan>
              </text>
              <text fill="#3B82F6" transform="translate(60 60)">
                <tspan x="3.511" y={118}>
                  W
                </tspan>
              </text>
